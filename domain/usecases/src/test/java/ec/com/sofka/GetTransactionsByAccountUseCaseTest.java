...
import ec.com.sofka.appservice.transaction.GetTransactionsByAccountUseCase;
...
class GetTransactionsByAccountUseCaseTest {
    ...
    void setUp() {
        ...
        useCase = new GetTransactionsByAccountUseCase(transactionRepository, accountRepository, busMessage);
    }

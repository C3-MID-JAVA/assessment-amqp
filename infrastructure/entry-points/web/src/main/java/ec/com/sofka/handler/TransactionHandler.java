...
import ec.com.sofka.mapper.TransactionResponseMapper;
import ec.com.sofka.appservice.transaction.CreateTransactionUseCase;
import ec.com.sofka.appservice.transaction.GetAllByAccountNumberUseCase;
...
public class TransactionHandler {
    ...
    public Mono<ServerResponse> create(ServerRequest request) {
        return request.bodyToMono(TransactionRequestDTO.class)
                ...
                .map(TransactionResponseMapper::toEntity)
                .flatMap(createTransactionUseCase::apply)
                .map(TransactionResponseMapper::fromEntity)

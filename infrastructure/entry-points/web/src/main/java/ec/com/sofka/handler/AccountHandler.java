...
import ec.com.sofka.appservice.account.GetAccountByNumberUseCase;
import ec.com.sofka.appservice.account.GetAllByUserIdUseCase;
import ec.com.sofka.dto.AccountRequestDTO;
import ec.com.sofka.mapper.AccountResponseMapper;
...
public class AccountHandler {
    ...
    public Mono<ServerResponse> getByAccountNumber(ServerRequest request){
        ...
        return getAccountByNumberUseCase.apply(accountNumber)
                .map(AccountResponseMapper::fromEntity)
    ...
    public Mono<ServerResponse> create(ServerRequest request) {
        return request.bodyToMono(AccountRequestDTO.class)
                ...
                .map(AccountResponseMapper::toEntity)
